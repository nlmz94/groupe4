...
public class EmployeeService {
    ...
    public List<EmployeeDto> getAllByFirstName() {
        List<Employee> list = EmployeeMapper.toEmployeesList(employeeRepository.findAllOrderByFirstNameAsc());
        return EmployeeMapper.toEmployeesDtoList(list);
    }
